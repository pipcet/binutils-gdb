...
#define TARGET_FORMAT "elf64-wasm64"

/* This macro is the BFD architecture to pass to `bfd_set_arch_mach'.  */
#define TARGET_ARCH bfd_arch_wasm64
...
//#define TC_FORCE_RELOCATION(fix)	wasm64_force_relocation (fix)
extern int wasm64_force_relocation (struct fix *);
...
//#define TC_VALIDATE_FIX_SUB(fix, seg)   wasm64_validate_fix_sub (fix)
extern int wasm64_validate_fix_sub (struct fix *);
...
/* 64 bit addresses are used on WASM64.  */
#define DWARF2_ADDR_SIZE(bfd) 8
...
#define md_allow_local_subtract(l,r,s) wasm64_allow_local_subtract (l, r, s)
extern bfd_boolean wasm64_allow_local_subtract (expressionS *, expressionS *, segT);

#define elf_tc_final_processing 	wasm64_elf_final_processing
extern void wasm64_elf_final_processing (void);

#define md_post_relax_hook wasm64_post_relax_hook ()
extern void wasm64_post_relax_hook (void);

extern void wasm64_start_line_hook (void);
#define md_start_line_hook() wasm64_start_line_hook ()

#define HANDLE_ALIGN(fragP) wasm64_handle_align (fragP)
extern void wasm64_handle_align (fragS *fragP);

struct wasm64_frag_data
{
  unsigned is_org : 1;
  unsigned is_align : 1;
  unsigned has_fill : 1;
...
#define TC_FRAG_TYPE			struct wasm64_frag_data
