...
WASM_OPCODE("i32.wrap/i64", i64, i32, conv, agnostic, 0xa7)
WASM_OPCODE("i32.trunc_s/f32", f32, i32, conv, signed, 0xa8)
WASM_OPCODE("i32.trunc_u/f32", f32, i32, conv, unsigned, 0xa9)
WASM_OPCODE("i32.trunc_s/f64", f64, i32, conv, signed, 0xaa)
WASM_OPCODE("i32.trunc_u/f64", f64, i32, conv, unsigned, 0xab)
WASM_OPCODE("i64.extend_s/i32", i32, i64, conv,   signed, 0xac)
WASM_OPCODE("i64.extend_u/i32", i32, i64, conv, unsigned, 0xad)
WASM_OPCODE("i64.trunc_s/f32", f32, i64, conv, signed, 0xae)
WASM_OPCODE("i64.trunc_u/f32", f32, i64, conv, unsigned, 0xaf)
WASM_OPCODE("i64.trunc_s/f64", f64, i64, conv, signed, 0xb0)
WASM_OPCODE("i64.trunc_u/f64", f64, i64, conv, unsigned, 0xb1)

WASM_OPCODE("f32.convert_s/i32", i32, f32, conv, signed, 0xb2)
WASM_OPCODE("f32.convert_u/i32", i32, f32, conv, unsigned, 0xb3)
WASM_OPCODE("f32.convert_s/i64", i64, f32, conv, signed, 0xb4)
WASM_OPCODE("f32.convert_u/i64", i64, f32, conv, unsigned, 0xb5)
WASM_OPCODE("f32.demote/f64", f64, f32, conv, floating, 0xb6)
WASM_OPCODE("f64.convert_s/i32", i32, f64, conv, signed, 0xb7)
WASM_OPCODE("f64.convert_u/i32", i32, f64, conv, unsigned, 0xb8)
WASM_OPCODE("f64.convert_s/i64", i64, f64, conv, signed, 0xb9)
WASM_OPCODE("f64.convert_u/i64", i64, f64, conv, unsigned, 0xba)
WASM_OPCODE("f64.promote/f32", f32, f64, conv, floating, 0xbb)

WASM_OPCODE("i32.reinterpret/f32", f32, i32, conv, agnostic, 0xbc)
WASM_OPCODE("i64.reinterpret/f64", f64, i64, conv, agnostic, 0xbd)
WASM_OPCODE("f32.reinterpret/i32", i32, f32, conv, agnostic, 0xbe)
WASM_OPCODE("f64.reinterpret/i64", i64, f64, conv, agnostic, 0xbf)
