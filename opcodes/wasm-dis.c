...
static void
print_insn_wasml (bfd_vma pc ATTRIBUTE_UNUSED,
...
bfd_boolean
wasm_symbol_is_valid (asymbol * sym,
...
void
parse_wasm_disassembler_option (char *option);
void
parse_wasm_disassembler_option (char *option)
{
  if (option == NULL)
...
parse_disassembler_options (char *options)
{
  ...
  while (*options)
    {
      parse_wasm_disassembler_option (options);
...
void print_wasm_disassembler_options(FILE *);
void
print_wasm_disassembler_options (FILE *stream)
{
  fprintf (stream, _("\n\
